...
import libs.tencentcloud
from libs.tencentcloud.common.exception.tencent_cloud_sdk_exception import TencentCloudSDKException
from libs.tencentcloud.common.exception import TencentCloudSDKException as SDKError
from libs.tencentcloud.common.http.request import ApiRequest, ResponsePrettyFormatter
from libs.tencentcloud.common.http.request import RequestInternal
from libs.tencentcloud.common.profile.client_profile import ClientProfile, RegionBreakerProfile
from libs.tencentcloud.common.sign import Sign
from libs.tencentcloud.common.circuit_breaker import CircuitBreaker
...
class AbstractClient(object):
    ...
    _endpoint = ''
    _service = ''
    _sdkVersion = 'SDK_PYTHON_%s' % libs.tencentcloud.__version__
