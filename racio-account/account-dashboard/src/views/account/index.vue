        ...
        <el-row class="row-bg" :gutter="11">
            ...
            <el-col :span="24">
                <el-table :data="tableData" style="width: 100%">
                    ...
                    <el-table-column prop="workplace" label="空间名" />
                    <el-table-column prop="name" label="创建者" width="180" />
                    <el-table-column prop="name" label="管理员配额" width="100" />
                    <el-table-column prop="name" label="应用构建配额" width="120" />
                    <el-table-column prop="name" label="普通用户数" width="120" />
                    <el-table-column prop="email" label="本周访客数" width="120" />
                    ...
                    <el-table-column label="操作" fixed="right" width="180">
                        <template #default="scope">
                            ...
                            <el-button type="danger">移除空间</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-col>
