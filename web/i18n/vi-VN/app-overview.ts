const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Hoặc thử phiên bản điện toán đám mây của Racio với báo giá miễn phí',
  },
  overview: {
    title: 'Tổng quan',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Giúp khách truy cập hiểu được dữ liệu mà ứng dụng thu thập, xem <privacyPolicyLink>Chính sách bảo mật</privacyPolicyLink> của Racio.',
        },
      },
      embedded: {
        entry: 'Nhúng',
